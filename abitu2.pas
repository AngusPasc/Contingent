...
procedure Tabituz.FormActivate(Sender: TObject);
begin
 ...
 filtr := '(otd=3) and ((zach<>0) or (zach1<>0))';
 DataModule1.baza_h.Filter := filtr;
 DataModule1.baza_h.Filtered :=True;
end;

procedure Tabituz.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
procedure Tabituz.BitBtn2Click(Sender: TObject);
var
...
//  DBLookupComboBox1.SetFocus;
 ...
 if nompr.Text='' then
  ...
  filtr := '(otd=3) and (zapis>0) and ((zach='+inttostr(zach)+') or (zach1='+inttostr(zach)+'))';
  DataModule1.baza_h.Filter := filtr;
  DataModule1.baza_h.Filtered :=True;
 ...
 DataModule1.baza_h.Filtered :=False;
 filtr := '(otd=3) and ((zach='+inttostr(zach)+') or (zach1='+inttostr(zach)+'))';
 DataModule1.baza_h.Filter := filtr;
 DataModule1.baza_h.Filtered :=True;
...
procedure Tabituz.BitBtn1Click(Sender: TObject);
begin
 close;
end;

procedure Tabituz.DBGrid1CellClick(Column: TColumn);
begin
...
procedure Tabituz.DBLookupComboBox1Click(Sender: TObject);
begin
