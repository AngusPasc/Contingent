object spr_spotd: Tspr_spotd
  Left = 336
  Top = 284
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1092#1086#1088#1084#1099' '#1086#1073#1091#1095#1077#1085#1080#1103
  ClientHeight = 267
  ClientWidth = 285
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Width = 273
    Height = 177
    DataSource = DataModule1.DataSource_w33
    TabOrder = 0
    ...
    Columns = <
      ...
      item
        ...
        Title.Caption = #1060#1086#1088#1084#1099' '#1086#1073#1091#1095#1077#1085#1080#1103
