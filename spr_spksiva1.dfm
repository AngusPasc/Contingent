object spr_spksiva: Tspr_spksiva
  Left = 362
  Top = 203
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1076#1086#1082#1091#1084#1077#1085#1090#1086#1074' '#1083#1080#1095#1085#1086#1089#1090#1080
  ClientHeight = 274
  ClientWidth = 298
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Width = 273
    Height = 177
    DataSource = DataModule1.DataSource_w14
    TabOrder = 0
    ...
    Columns = <
      ...
      item
        ...
        Title.Caption = #1044#1086#1082#1091#1084#1077#1090' '#1083#1080#1095#1085#1086#1089#1090#1080
