object spr_spmil3: Tspr_spmil3
  Left = 294
  Top = 116
  Width = 299
  Height = 298
  Caption = #1057#1087#1088#1072#1074#1086#1095#1085#1080#1082' '#1074#1086#1080#1085#1089#1082#1080#1081' '#1089#1086#1089#1090#1072#1074
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Width = 273
    Height = 177
    DataSource = DataModule1.DataSource_w22
    TabOrder = 1
    ...
    Columns = <
      ...
      item
        ...
        Title.Caption = #1042#1086#1080#1085#1089#1082#1080#1081' '#1089#1086#1089#1090#1072#1074
